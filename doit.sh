...
verilator -Wall --cc --trace EightDeMux.sv --exe top_tb.cpp
verilator -Wall --cc --trace EightMux.sv --exe top_tb.cpp
verilator -Wall --cc --trace FourDeMux.sv --exe top_tb.cpp
verilator -Wall --cc --trace TwoDeMux.sv --exe top_tb.cpp
