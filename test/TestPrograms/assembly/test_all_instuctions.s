...
#testing loop (meric)
main:
    li    t0, 4    # Initialize t0 with 10
    addi    t1, zero, 2      # Initialize t1 with 2 (loop counter)
...
loop:
    ...
    jal     x1, func         # Jump to func, store return address in ra

addi t1, t1, 100 #to confirm jalr

func:
    addi    t4, zero, 5      # Initialize t4 with 5
    jalr    zero, x1, 0      # Return to the address in ra
